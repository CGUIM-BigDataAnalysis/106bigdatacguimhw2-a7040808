...
### 各個國家來台灣唸書的學生人數條狀圖
```{r ToTWNCountryBar,warning = FALSE,message = FALSE}
...
```{r FromTWNCountry,warning = FALSE,message = FALSE}
Q5<-ComPop
...
### 哪間大學的出國交流學生數最多呢？
```{r FromTWNUniversity,warning = FALSE,message = FALSE}
...
```{r FromTWNCountryBar,warning = FALSE,message = FALSE}
...
### 台灣學生最喜歡去哪些國家留學呢？
```{r FromTWNAb,warning = FALSE,message = FALSE}
